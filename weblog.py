...
app.config['SECRET_KEY'] = 'phoenix1x1593572468x8xineohp'
app.config['UPLOAD_FOLDER'] = 'static/pictures'
app.config['UPLOAD_FOLDER_2'] = 'static/videos'
...
def register():
    ...
    if form.validate_on_submit():
        ...
        new_user = User(name=form.name.data, username=form.username.data, password=hashed_password, role='Author')
...
def edit(ids):
    form = PostForm()
    post = Post.query.get_or_404(ids)
    ...
    try:
        ...
        return 'there was an eror in updating!'
...
def deletes(id):
    ...
    try:
        ...
        return 'there was an eror in deleting!'
